...
public class Sintatico implements Constants
{
    ...
    private boolean step() throws LexicalError, SyntaticError, SemanticError
    {
        ...
        switch (cmd[0])
        {
            ...
            case ERROR:
                msg_erro = PARSER_ERROR[state];
                msg_erro = msg_erro + "\nOcorreu um erro sintático na posição " + this.currentToken.getPosition();
                msg_erro = msg_erro + "\nToken inesperado: " + this.currentToken.getLexeme();                
                throw new SyntaticError(msg_erro, currentToken.getPosition());
        }
        return false;
    }
